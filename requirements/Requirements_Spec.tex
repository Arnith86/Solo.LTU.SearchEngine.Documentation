...
2. Symbol: ! or - \newline
Constraint: The exclusion operator must be preceded by a positive term (e.g., "cat -dog"). Standalone exclusion queries shall return an error or zero results. & TC-FRQ-3008 \\
...
FRQ-3011 & Literal Search with Escaping. The system shall correctly interpret escaped characters as literal values within a query. & TC-FRQ-3010 \\
                       ...
                       & \\
FRQ-3012 & Results of queries must be paginated when more than 10 results are found. &  TC-FRQ-3012 \\
FRQ-3013 & The results should contain the headline of the context found. & TC-FRQ-3013\\
FRQ-3014 & The results should contain a snippet with keywords highlighted. & TC-FRQ-3014\\
...
Example:    For the query "cat dog", a document containing both "cat" and "dog" with high term frequency 
            ...
            or appearing on a low-ranked page. &  TC-FRQ-3015 \\
